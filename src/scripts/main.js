...
class App {
    constructor() {
        ...
        this.routes = {
            ...
            'project-SyntheticDataGen': 'src/views/projectDescriptions/underConstruction.html',
            'project-BBShield': 'src/views/projectDescriptions/underConstruction.html',
            'project-DigitalThermometer': 'src/views/projectDescriptions/underConstruction.html',
            'project-WaferDefectDetection': 'src/views/projectDescriptions/underConstruction.html',
            'project-DataCleanRoom': 'src/views/projectDescriptions/underConstruction.html',
            'project-SolarCar': 'src/views/projectDescriptions/underConstruction.html',
            'project-PrivateTutoring': 'src/views/projectDescriptions/underConstruction.html',
            // Placeholder routes for other projects (create these files when ready)
            'project-ecommerce': 'src/views/projectDescriptions/underConstruction.html',
            'project-taskmanager': 'src/views/projectDescriptions/underConstruction.html',
            'project-designsystem': 'src/views/projectDescriptions/underConstruction.html',
            'project-fitnesstracker': 'src/views/projectDescriptions/underConstruction.html',
            'project-analytics': 'src/views/projectDescriptions/underConstruction.html',
            'project-socialmedia': 'src/views/projectDescriptions/underConstruction.html',
            'project-brandidentity': 'src/views/projectDescriptions/underConstruction.html',
            'project-weather': 'src/views/projectDescriptions/underConstruction.html',
        };
        this.init();
    }
